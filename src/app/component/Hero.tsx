            ...
            <div>
                <div className='flex flex-col md:flex-row bg-[#F4F4F4] justify-around mx-auto p-10'>
                    ...
                    <div>
                        <Image
                            ...
                            height={500}
                            width={500}
                            src='/Cloud sofa three seater + ottoman_3 1.jpg'
                        />
                        <h3 className='text-3xl font-medium'>Side table</h3>
                        <Link href='/'>
                            <p className="text-xl mt-8 underline underline-offset-8 text-black-600 ">View More</p>
                ...
                <div className=" md:flex-row bg-[#FFFFFF] justify-around mx-auto py-10 px-4">
                    ...
                    <div className="flex flex-wrap justify-center md:justify-start  gap-6 ">
                        {/* Product Item */}
                        {[
                            { src: '/Mask group 1.jpg', name: 'Trenton modular sofa_3', price: 'Rs. 25,000.00' },
                            { src: '/Mask group.png', name: 'Granite dining table with dining chair', price: 'Rs. 25,000.00' },
                            { src: '/Group 16.jpg', name: 'Outdoor bar table and stool', price: 'Rs. 25,000.00' },
                            { src: '/Mask group.jpg', name: 'Plain console with teak', price: 'Rs. 25,000.00' },
                        ].map((item, index) => (
